...
def create_dot_env_file(root_path: str, env: str):
...
def write_envfile(root_path: str):
    with open("/tmp/envfile", "w") as env_file:
        dot_env_path = os.path.join(root_path, ".env")
        env_file.write(dot_env_path)
...
if __name__ == "__main__":
    ...
    create_dot_env_file(root_dir, env)
    add_project_version_to_dot_env(root_dir)

    write_envfile(root_dir)
